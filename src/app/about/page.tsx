                      ...
                      <article className="w-full h-full place-content-center select-none">
                        <div className="h-fit">
                            <div className="grid md:flex md:float-right float-none md:pl-4">
                                <img className="flex-initial float-none justify-self-center md:float-right rounded-default size-50 md:size-80 shrink p-0 md:p-4 bg-light-secondary/15 dark:bg-dark-secondary/25" src="/media/jj-k-droid-git-pfp.webp"/>
                            </div>
                            <div className="flex-col basis-0 md:basis-2/3 pr-0 md:pr-7 h-full">
                                <p className="pt-5 md:pt-0 font-heading text-2xl md:text-3xl text-light-primary/80 dark:text-dark-primary">hi, hello! i{"'"}m steph (or jj) :{")"}</p>
                                <div className="text-lg pb-12 md:pb-0">
                                    ...
                                    <p>i{"'"}m interested in software engineering/development, web development and computer engineering - which i hope to peruse a masters in. oustide of coding, i like to read, draw, listen to music, game and make things (sculptures, functional 3d prints, woodworking projects...)</p>
                                    <br></br>
                                    <p>i{"'"}m currently looking for software, computer engineering and web development internships or networking opportunites. if you know of any open positions or just want to say hi, feel free to reach out at <a className="text-light-primary/80 hover:text-light-primary dark:text-dark-primary dark:hover:text-dark-subtitle underline" href="mailto:kamakama@grinnell.edu">kamakama@grinnell.edu</a> or using any one of my socials linked <a className="text-light-primary/80 hover:text-light-primary dark:text-dark-primary dark:hover:text-dark-subtitle underline" href="/links">here :{")"}</a></p>
                                    <p>i can use:</p>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-5 lg:grid-cols-6 content-center grid-auto-flow-col space-x-3 md:space-x-4">
                                        <p className="p-1 md:p-2 my-1 w-auto min-w-fit rounded-default h-fit bg-light-inactive-tab dark:bg-dark-inactive-tab hover:bg-light-secondary/80 active:text-light-active-text active:bg-light-secondary hover:text-light-active-text dark:text-dark-inactive-text dark:hover:bg-dark-secondary/80 dark:hover:text-dark-inactive-text text-center md:text-left">&nbsp;c&nbsp;</p>
                                        <p className="p-1 md:p-2 my-1 w-auto min-w-fit rounded-default h-fit bg-light-inactive-tab dark:bg-dark-inactive-tab hover:bg-light-secondary/80 active:text-light-active-text active:bg-light-secondary hover:text-light-active-text dark:text-dark-inactive-text dark:hover:bg-dark-secondary/80 dark:hover:text-dark-inactive-text text-center md:text-left">react</p>
                                        <p className="p-1 md:p-2 my-1 w-auto min-w-fit rounded-default h-fit bg-light-inactive-tab dark:bg-dark-inactive-tab hover:bg-light-secondary/80 active:text-light-active-text active:bg-light-secondary hover:text-light-active-text dark:text-dark-inactive-text dark:hover:bg-dark-secondary/80 dark:hover:text-dark-inactive-text text-center md:text-left">git</p>
