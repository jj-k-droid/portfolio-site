                            ...
                            <div className="h-fit">
                                ...
                                <div className="flex-col basis-0 md:basis-2/3 pr-0 md:pr-7 h-full">
                                    <div className="text-lg pb-12 md:pb-0">
                                        <p> a junior <a className="bg-light-secondary/25 dark:bg-dark-secondary/50">computer science major</a>. a lot of my current experience comes from making small games or software prototypes, a few personal projects (like this website!) and classes i have taken</p>
