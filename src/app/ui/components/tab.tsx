...
export default function Tab({ children, className, name, ...rest } : TabProps) {
    ...
    if (name === "active") {
        ...
        return <main >
            <button
                {...rest}
                className="flex bg-light-inactive-tab rounded-tab pt-tab pl-tab-l pr-tab-r font-heading md:text-xl lg:text-2xl text-light-inactive-text 
                ...
                active:border-light-secondary dark:border-dark-inactive-tab/0 dark:hover:border-dark-secondary/0 dark:active:border-dark-secondary">
                    {children}
                </button>
        </main>
    };
